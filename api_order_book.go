...
// OrderBookAPIService orderbook api service
type OrderBookAPIService service

// OrderBookGetL2Opts optinal args for get current orderbook
type OrderBookGetL2Opts struct {
	Depth optional.Float32
}

// OrderBookGetL2 get current orderbook in vertical format.
