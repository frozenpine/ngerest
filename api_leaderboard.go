...
// LeaderboardAPIService leader board api service
type LeaderboardAPIService service

// LeaderboardGetOpts optinal args for getting current leaderboard
type LeaderboardGetOpts struct {
	Method optional.String
}

// LeaderboardGet get current leaderboard.
...
// LeaderboardGetName get your alias on the leaderboard.
func (a *LeaderboardAPIService) LeaderboardGetName(ctx context.Context) (InlineResponse2001, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/leaderboard/name"
